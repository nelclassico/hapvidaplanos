	...
	<div class="container">
		...
		<div id="brand" class="brands">
			...
			<div class="logo-hapvida">
				<a href="<?php echo esc_url( home_url( '/fortaleza' ) ); // Link to the home page ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); // Title it with the blog name ?>" rel="home">
