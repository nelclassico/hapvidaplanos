...
get_header(); // This fxn gets the header.php file and renders it ?>
	<div id="primary" class="grid">
		<div id="content" role="main" class="col-small-4 col-large-9">
			...
			?>
				...
				?>
					...
					<article class="post">
                      <?php // Quando precisar dar um clear nos floats, basta usar a classe grid,
                            // pois ela também serve para isto, além de comportar o grid. ?>
                        <div class="grid">
                            <h1 class="title"><?php the_title(); // Display the title of the post ?></h1>

                            <div class="post-meta">
                                <?php the_time('dMY'); // Display the time it was published ?>
		...
		<div id="sidebar" role="sidebar" class="col-small-4 col-large-3">
